...
SBomber::SBomber()
    ...
    score(0)
{
    FileLoggerSingletoneProxy::getInstance().WriteToLog(string(__FUNCTION__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
    ...
    FileLoggerSingletoneProxy::getInstance().WriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    FileLoggerSingletoneProxy::getInstance().WriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
